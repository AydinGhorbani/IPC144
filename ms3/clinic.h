...
// to sort files with bubble sorting (https://www.programmingsimplified.com/c/source-code/c-program-bubble-sort) /////////// (T_T)
...
// Find the patient array index by patient number
